...
ALTER TABLE MP_SHIPMENT ADD CONSTRAINT unique_shipment_receiver UNIQUE(SH_FK_receiver);
...
ALTER TABLE MP_PAC_CHA ADD CONSTRAINT fk_pac_cha_package FOREIGN KEY(PACH_FK_package) REFERENCES MP_PACKAGE(PA_id);
ALTER TABLE MP_PAC_CHA ADD CONSTRAINT fk_pac_cha_characteristic FOREIGN KEY(PACH_FK_characteristic) REFERENCES MP_CHARACTERISTIC(CH_id);
